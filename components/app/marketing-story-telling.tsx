      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-8 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <Image
            ...
            className="bg-secondary-foreground ring-secondary-foreground/10 w-[48rem] max-w-none rounded-xl shadow-xl ring-1 grayscale sm:w-[57rem]"
            width={1860}
            height={862}
          />
        </div>
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="text-secondary-foreground/70 max-w-xl text-base leading-7 lg:max-w-lg">
              <p>
              ...
              <ul role="list" className="text-muted-foreground mt-8 space-y-8">
